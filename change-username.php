...
<head>
    ...
    <style>
        .main-page .edit-form #changeUser {
        ...
        <div class="main-page" id="main-page">
            ...
            <div class="edit-form-sec">
                <div class="edit-form">
                    ...
                    <div class="profile-form2" id="username">
                        <h1>CHANGE USERNAME</h1>
                        <form action="update-username.php" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="users_id" id="users_id" value="<?php echo $users_id ?>">
                            <div class="space"> </div>
                            <div class="user-infoo">
                            <label for="oldUser">Old Username</label><br>
                            <input id="oldUser" type="text" name="oldUser" required><br>
                            <label for="newUser">New Username</label><br>
                            <input id="newUser" type="text" name="newUser" required><br>
                            <label for="confirmUser">Password for Confirmation</label><br>
                            <input id="confirmUser" name="confirmUser" type="password" required><br>
                            </select><br>
                            <div class="button">
