...
<div class="bg-photo">
    ...
    <div class="homepage" id="homepage" style="display: non">
        ...
        <div class="header">
            ...
            <div class="dashboard-area">
                ...
                <div class="map">
                    <button class="mapbutton" id="buttonMap">MAP</button>
                </div>
                        ...
                        <div class="contents" id="contents">
                            ...
                            <div class="services">
                                ...
                                <div class="column2">
                                    ...
                                    <p>Click <a href="admin-announcement.php">here</a> to see announcement regarding health
                                        care events</p>
                                </div>
                            </div>
